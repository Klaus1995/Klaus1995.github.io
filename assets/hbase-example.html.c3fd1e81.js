import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.902c8dae.js";const p={},o=t(`<h1 id="hbase-连接器示例" tabindex="-1"><a class="header-anchor" href="#hbase-连接器示例" aria-hidden="true">#</a> Hbase 连接器示例</h1><h2 id="读写的hbase配置示例" tabindex="-1"><a class="header-anchor" href="#读写的hbase配置示例" aria-hidden="true">#</a> 读写的HBase配置示例</h2><ul><li>在本地使用docker启动一个HBase集群，则默认配置为：</li></ul><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="读连接器示例" tabindex="-1"><a class="header-anchor" href="#读连接器示例" aria-hidden="true">#</a> 读连接器示例</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
